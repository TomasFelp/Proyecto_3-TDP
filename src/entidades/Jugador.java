...
public class Jugador extends Personaje implements Colisionable {
	...
	/**
	 * Cambia el estado del jugador indicando que esta en posesion de un premio
	 * temporal.
	 * 
	...
	/**
	 * Quita todos los premios temporales que pueda poseer el jugador y cambia su
	...
	public float getPorcentajeVida() {
		return (float) ((cargaViral + 0.0) / maxVida);
	}
}
